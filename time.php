...
?>
<?php
if(isset($_POST['datetime1']) && isset($_POST['datetime2']) && isset($_POST['cname'])){
	...
	$sql = "UPDATE thoigian SET timebegin='".$datetime1."', timeend='".$datetime2."', name='".$_POST['cname']."' WHERE id=1";
	echo $sql;
